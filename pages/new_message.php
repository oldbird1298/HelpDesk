        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Νέο Μύνημα</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form class="form-horizontal" action="../php_functions/send_message.php" method="POST">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">To : </label>
                                <div class="col-sm-4">
                                    <input class="hidden" name="sender"  value="<?php echo $sender ?>">
                                    <select class="form-control" name="to_sender" required="Select">
                                        <option value="" selected disabled>Αποστολέας </option>
                                        <?php
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $db->runQuery("SET NAMES 'utf8'");
                                        $sql = "SELECT `AM`, `rank_name`, `surname` FROM `personel`";
                                        $sender = $db->runQuery($sql);
                                        while ($row_sender = mysqli_fetch_array($sender)) {
                                            echo "<option value=\"" . $row_sender['AM'] . "\">" . $row_sender['rank_name'] . " " . $row_sender['surname'] . "</option>";
                                        }
                                        ?>
                                        <option class="text-primary" value="all">Σε όλους</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="subject" class="form-control" placeholder="Θέμα" required="thema">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Text : </label>
                                <div class="col-sm-4">
                                    <textarea  name="text" class="form-control" rows="10" placeholder="Κείμενο"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
