...
<html lang="en">
    ...
    <head>
        ...
        <title>HD Admin 2 - Prosklitirio</title>
        ...
        <div id="wrapper">
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="HAFchat.php" target="popup" onclick="window.open('HAFchat.php', 'popup', 'width=600,height=480'); return false;">HAF Chat</a>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Προσκλητήριο</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading text-center">
                                        <strong>Προσκληρήριο - <?php echo date("j - m - Y"); ?></strong>
                                    </div>
                                    <div class="panel-body">
                                        <div class="dataTables_wrapper">
                                            ...
                                            $class = "table";
                                            $headArray = array("#", "Βαθμός", "Ονομα", "Επιθετο", "Τηλ");
                                            $head = count($headArray);
                                            $sql = "SELECT `rank_id`, `rank_name`, `name`, `surname`, `telephone` FROM `personel` ORDER BY `personel`.`rank_id` ASC";
                                            $db = new DbMgmt;
                                            $db->runQuery("SET NAMES 'utf8'");
                                            $res = $db->runQuery($sql);
                                            echo "<table class=\"table table-striped table-bordered table-hover\" id=\"personel\">";
                                            echo "<caption class=\"text-center \">Λίστα Προσωπικού</caption>";
                                            echo "<thead>";
                                            echo "<tr>";
                                            for ($i = 0; $i < $head; $i++) {
                                            ...
                                            echo "<tbody>";
                                            while ($row_personel = mysqli_fetch_array($res)) {
                                                echo "<tr>";
                                                echo "<td>" . $row_personel['rank_id'] . "</td>";
                                                echo "<td>" . $row_personel['rank_name'] . "</td>";
                                                echo "<td>" . $row_personel['name'] . "</td>";
                                                echo "<td>" . $row_personel['surname'] . "</td>";
                                                echo "<td>" . $row_personel['telephone'] . "</td>";
                                                echo "</tr>";
                                            }
