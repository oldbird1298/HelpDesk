                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTables_wrapper">
                                ...
                                $class = "table";
                                $headArray = array("#", "From", "Subject", "text");
                                $head = count($headArray);
                                $sql = "SELECT  `from`, `subject`, `text` FROM `messages` WHERE `to`=$for ";
                                $db = new DbMgmt;
                                $db->runQuery("SET NAMES 'utf8'");
                                $res = $db->runQuery($sql);
                                echo "<table class=\"table table-striped table-bordered table-hover\" id=\"personel\">";
                                echo "<caption class=\"text-center \">Εισερχόμενα</caption>";
                                echo "<thead>";
                                echo "<tr>";
                                for ($i = 0; $i < $head; $i++) {
                                ...
                                echo "<tbody>";
                                while ($row_incoming = mysqli_fetch_array($res)) {
                                    $tin = 1;
                                    echo "<tr>";
                                    echo "<td>" . $tin . "</td>";
                                    echo "<td>" . $row_incoming['from'] . "</td>";
                                    echo "<td>" . $row_incoming['subject'] . "</td>";
                                    echo "<td>" . $row_incoming['text'] . "</td>";
