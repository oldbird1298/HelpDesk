...
//                                        $class = "table table-striped table-bordered table-hover";
                                            ...
                                            $db = new DbMgmt();
                                            $db->runQuery("SET NAMES 'utf8'");
                                            $sql = "SELECT `subject_id`, `subject`, `user_reg`, `exp_date`  FROM `tbl_tasks` WHERE `user_id`=$am AND `isAssigned`=0 OR `Forwarder`=$am AND `isAssigned`=0";
...
<!--                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $db = new DbMgmt();
                                                        $db->runQuery("SET NAMES 'utf8'");
                                                        $sql_pendings = "SELECT `subject_id`, `subject`, `user_reg`, `user_id` FROM `tbl_tasks` WHERE `isAssigned`=0 AND `user_reg`=$am";
                                                        $res_pendings = $db->runQuery($sql_pendings);

                                                        while ($row_pendings = mysqli_fetch_array($res_pendings)) {
                                                            echo "<tr class=\"danger\">";
                                                            echo "<td>" . $row_pendings['subject_id'] . "</td>";
                                                            echo "<td>" . $row_pendings['subject'] . "</td>";
                                                            echo "<td>" . $row_pendings['user_reg'] . "</td>";
                                                            echo "<td>" . $row_pendings['user_id'] . "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
                                    ...
                                    <div class="panel panel-danger" id="AssignedTasks">
                                        <div class="panel-heading text-center text-muted">
...
//                                                    taskButtonHandlers();
                                    ...
                                    <div class="panel panel-success" id="CompletedTasks">
                                        <div class="panel-heading text-center text-muted">
