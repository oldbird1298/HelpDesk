...
<html lang="en">
    ...
    <body class="nav-md">
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Site Status <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="network.php">Radios </a>
                                            </li>
                                            <li><a href="../empty.html">Ασύρματοι</a>
                                            </li>
                                            <li><a href="../empty.html">Radar</a>
                                            </li>
                                            <li><a href="../empty.html">Radar</a>
                                            </li>
                                        </ul>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="dashboard_graph">
                                ...
                                <div class="row x_title">
                                    <div class="col-md-6">
                                        <h3>Network <small>Monitor</small></h3>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <!-- Tiltle Start -->
                                <div class="x_title">
                                    <h2>Network Analyzer <small>Monitor Interfaces</small></h2>
                                ...
                                <div class="x_content">
                                    <br />
                                    <form name="check_host" id="demo-form2" data-parsley-validate class="form-inline form-label-left">

                                        <div class="well bg-blue-sky" style="overflow: auto">
                                            <div class="form-group">
                                                <label class="control-label col-md-4 col-sm-12 col-xs-12"><strong>Unit : </strong></label>
                                            ...
                                            <div class="form-group pull-right">
                                                <label class="control-label  col-md-4 col-sm-12 col-xs-12"><strong>Device : </strong></label>
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                    <select name="device" class="form-control" onchange="window.loadSection()">
                                    ...
                                    <div id='section_container' class="col-md-12" style="float:left"></div>
        ...
        <script src="../php/pingApp/loadSection.js" type="text/javascript"></script>
        <!-- pace -->
